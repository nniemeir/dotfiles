...
selection=$(echo "$bookFiles" | xargs -I {} basename "{}" | sed 's/\.[^.]*$//' | fzf --height=80% --padding=5,40,0,40 --layout=reverse --cycle --preview='
file_path=/home/natalie/MEGA/Academic/Books/covers/{}
file_name="${file_path%.*}"
